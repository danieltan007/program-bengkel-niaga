...
<nav class="navbar navbar-expand-md  bg-primary">
     <a class="navbar-brand" style="font-size:26px; padding-left:20px;"><img src="gudang.png" width="30" height="30"> GUDANG</a>
     <ul class="nav">
          <li class="nav-item">
               <a class="nav-link klik" id="home"><i class="fa fa-dropbox"></i> Barang</a>
          </li>
          <li class="nav-item">
               <a class="nav-link klik" id="laporan"><img src="barang masuk.png" width="27" height="28"> Restock</a>
          </li>
          <li class="nav-item">
               <a class="nav-link klik" id="brgklr"><img src="barang keluar.ico" width="25" height="28"> Barang Keluar</a>
          </li>
          <li class="nav-item">
