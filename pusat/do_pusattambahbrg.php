...
$hrg_jual2 = $_POST['input_jual2'];
$hrg_jual3 = $_POST['input_jual3'];
...
$query2 = "INSERT INTO `tabel pusat temp` (kd_brg, nm_brg, mrk_brg, sto_brg, supp_brg, hrg_modal, hrg_jual, hrg_jual2, hrg_jual3) VALUES ('$kd_brg','$nm_brg','$mrk_brg','$sto_brg','$supp_brg','$hrg_beli' ,'$hrg_jual', '$hrg_jual2', '$hrg_jual3')";
