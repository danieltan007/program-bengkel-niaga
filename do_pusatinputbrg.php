...
$sql1 = "select * from `table pusat temp`";
...
while ($data1 = mysqli_fetch_array($cari1)) {
     ...
     $sql4 = "insert into `tabel barang pusat` 
          ...
          ('$data1[kd_brg]', '$data1[nm_brg]', '$data1[mrk_brg]', 0,'$data1[sto_brg]' ,'$data1[supp_brg]', '$data1[hrg_beli]', '$data1[hrg_jual]')";
     mysqli_query($conn, $sql4);
}

$sql3 = "delete from `table pusat temp`";
